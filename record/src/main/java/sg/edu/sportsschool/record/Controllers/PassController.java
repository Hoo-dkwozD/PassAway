...
import sg.edu.sportsschool.record.Services.PassService;
...
public class PassController {
    ...
    // public ResponseEntity<JSONBody> findAllPassesByAttractionId(@RequestParam Integer aId) {
    //     return pService.findAllPassesByAttractionId(aId);
    // }
}
